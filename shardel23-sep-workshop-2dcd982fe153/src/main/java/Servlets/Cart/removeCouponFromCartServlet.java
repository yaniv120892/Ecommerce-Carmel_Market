...
@WebServlet(urlPatterns = "/removeCouponFromCart")
public class removeCouponFromCartServlet extends HttpServlet {
    ServiceProvider sc;

    public removeCouponFromCartServlet() {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        if (request.getSession().getAttribute("userID") == null) {
            ...
            try {
                ...
                String successString ="Coupon code  " + couponCode + " was removed successfully from the Cart";
