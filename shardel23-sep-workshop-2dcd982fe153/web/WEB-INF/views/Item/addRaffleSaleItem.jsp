...
<div id="content-outer">
    ...
    <div id="content">
        ...
        <!--  start page-heading -->
        <div id="page-heading">
            <h1>Add Raffle Sale Item for ${itemName}</h1>
        </div>
        <!-- end page-heading -->
        <c:choose>
                ...
                <td>
                    ...
                    <div id="content-table-inner">
                        ...
                        <div id="table-content">
                            ...
                            <!--  start message-green -->
                            <form id="myForm" method="post" action="${pageContext.request.contextPath}/addItemToSale?storeName=${storeName}&itemName=${itemName}&saleType=${saleType}">
