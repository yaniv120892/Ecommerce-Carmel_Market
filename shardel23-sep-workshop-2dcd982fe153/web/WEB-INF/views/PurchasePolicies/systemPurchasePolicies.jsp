...
<div id="content-outer">
    ...
    <div id="content">
        ...
        <!--  start page-heading -->
        <div id="page-heading">
            <h1>Purchase Policies for all stores</h1>
        </div>
        <c:choose>
                        ...
                        <div id="table-content">
                            ...
                            <div style="width: 600px; float: left;">
                                ...
                                <table border="0" width="50%" cellpadding="0" cellspacing="0" id="items-purchase-policies-table">
                                    ...
                                    <tr>
                                        <td>All Items</td>
                                        <td><a href="ruleDetails?itemName=">Show Rules</a></td>
                                        <td><a href="addRule?itemName=&">Add Rule</a></td>
                                        <td><a href="clearRule?itemName=&">Clear</a></td>
                                    </tr>
                                    <c:forEach items="${listItems}" var="item">
                                        <tr>
                                            <td>${item.getName()}</td>
                                            <td><a href="ruleDetails?itemName=${item.getName()}&">Show Rules</a></td>
                                            <td><a href="addRule?itemName=${item.getName()}&">Add Rule</a></td>
                                            <td><a href="clearRule?itemName=${item.getName()}&">Clear</a></td>
                                        </tr>
                                    </c:forEach>
                            ...
                            <div style="margin-left: 620px;">
                                ...
                                <table border="0" width="50%" cellpadding="0" cellspacing="0" id="categories-purchase-policies-table">
                                    ...
                                    <c:forEach items="${listCategories}" var="category">
                                        ...
                                        <tr>
                                            <td>${category}</td>
                                            <td><a href="ruleDetails?itemName=&categoryName=${category}&">Show Rules</a></td>
                                            <td><a href="addRule?itemName=&categoryName=${category}&">Add Rule</a></td>
                                            <td><a href="clearRule?itemName=&categoryName=${category}&">Clear</a></td>
                                        </tr>
                                    </c:forEach>
