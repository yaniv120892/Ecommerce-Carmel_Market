...
<div id="content-outer">
    ...
    <div id="content">
        ...
        <!--  start page-heading -->
        <div id="page-heading">
            <h1>${storeName} Purchase History</h1>
        </div>
        <!-- end page-heading -->
        <c:choose>
                            ...
                            <form id="mainform" action="">
                                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="table-header-repeat line-left"><a href="">User Email</a></th>
                                        <th class="table-header-repeat line-left"><a href="">Store Name</a></th>
                                        <th class="table-header-repeat line-left"><a href="">Amount Bought</a></th>
                                    ...
                                    <c:forEach items="${listPurchaseHistory}" var="purchase">
                                        <tr>
                                            <td>${purchase.getId()}</td>
                                            <td>${purchase.getItemName()}</td>
                                            <td>${purchase.getUserEmail()}</td>
                                            <td>${purchase.getStoreName()}</td>
                                            <td>${purchase.getAmountBought()}</td>
