                        ...
                        <div id="table-content">
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                ...
                                <tr>
                                    ...
                                    <th class="table-header-repeat line-left"><a href="">Close</a></th>
                                ...
                                <c:forEach items="${listStores}" var="store">
                                    <tr>
                                        ...
                                        <td><a class="icon-9" href="adminStores?storeNameToRemove=${store.getName()}"></a></td>
                                        <td><a class="icon-4" href="purchaseHistory?storeName=${store.getName()}"></a></td>
                                    </tr>
                                </c:forEach>
