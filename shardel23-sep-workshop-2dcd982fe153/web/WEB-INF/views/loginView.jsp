...
<div id="login-holder">
    ...
    //<script src="../../js/jquery/webSocketStats.js" type="text/javascript"></script>
    <!-- end logo -->
    ...
    <div id="loginbox">
        <!--  start login-inner -->
        <div id="login-inner">
            <form id="myForm" method="post" action="${pageContext.request.contextPath}/doLogin">
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <th></th>
                        <td><input type="submit" name="user" value="Login" class="guest-login"/>
                            <input type="submit" name="guest" value="Guest" class="guest-login"/>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
                        <td><input type="submit" name="register" value="Register" class="register-login"/></td>
                    </tr>
                </table>
            </form>
        </div>
    ...
    <div id="forgotbox">
        ...
        <!--  start forgot-inner -->
        <div id="forgot-inner">
            <form method="post" action="${pageContext.request.contextPath}/doForget">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <th>Email address:</th>
